...
stateDiagram-v2
  ...
  [*] --> TCS: Start
  TCS --> HO_Solutions: Foundation built
  HO_Solutions --> Horizon_Pharma: React unlocked
  Horizon_Pharma --> NIJI: Stack expanded
  NIJI --> FREE_Iliad: Frontend focused
  FREE_Iliad --> AI_Engineering: In progress...

  TCS: 🌱 Web Development Foundations
  TCS: 2016–2018
  TCS: JavaScript · HTML · CSS · REST

  HO_Solutions: ⚛️ React & Mobile Foundations
  HO_Solutions: 2019–2020
  HO_Solutions: React · React Native · Redux

  Horizon_Pharma: 📱 React + TypeScript Engineering
  Horizon_Pharma: 2020–2021
  Horizon_Pharma: React · React Native · TypeScript · Node.js

  NIJI: 🧩 Multi-Framework Engineering
  NIJI: 2021–2023
  NIJI: React · Next.js · Angular · Node.js · Azure

  FREE_Iliad: 🚀 Frontend Engineering
  FREE_Iliad: 2023–Present
  FREE_Iliad: Vue 3 · React · TypeScript · Pinia
